...
test('critical fonts and homepage images are self-hosted and responsive', async () => {
  ...
  assert.match(home, /hero-mobile-640-v3\.avif 640w/);
  assert.match(home, /hero-desktop-1280\.webp 1280w/);
  assert.match(home, /hero-desktop-1280-v3\.avif 1280w/);
  ...
  assert.match(home, /imagesrcset="\/img\/performance\/hero-mobile-640-v3\.avif 640w/);
